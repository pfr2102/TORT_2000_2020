       ...
       <main class="overflow-auto">       
            ...
            <div id="content_main">
                ...
                <div class="col-xs-12">
                    ...
                    <br>
                        <div>
                          <button type="button" class="btn btn-success btn-lg " onclick="agregaForm()" data-bs-toggle="modal" data-bs-target="#create"><ion-icon name="person-add"></ion-icon> Nuevo Empleado </button>                          
                   ...
                   /*$conexion=conectar(); 
                    ...
                    $busqueda = $_GET['busqueda'];
                        ...
                        if (isset($_GET['busqueda']))
                        {
                            ...
                            OR telefono  LIKE'%".$busqueda."%' OR fechaNac LIKE'%".$busqueda."%' OR curp LIKE'%".$busqueda."%' OR tipo LIKE'%".$busqueda."%'";
                        }
                ...
                <!--<div class="container-fluid">
                    <form class="d-flex">
                        ...
                        placeholder="Buscador por cualquier campo" name="buscador" id="buscador" autofocus>                        
                        <hr>
                    </form>
                </div>-->
                <br>
